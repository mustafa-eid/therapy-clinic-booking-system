...
Route::middleware('auth:web')->group(function () {
    ...
    Route::get('show-roles', [RolesAndPermissionsController::class, 'show'])->middleware('permission:Show Roles And Permmonsins');
    Route::get('create-roles', [RolesAndPermissionsController::class, 'createRole'])->middleware('permission:CreateRole Roles And Permmonsins');
    Route::post('add-role', [RolesAndPermissionsController::class, 'create'])->middleware('permission:Create Roles And Permmonsins');
    Route::get('edit-role/{id}', [RolesAndPermissionsController::class, 'editRole'])->middleware('permission:EditRrole Roles And Permmonsins');
    Route::post('update-role', [RolesAndPermissionsController::class, 'updateRole'])->middleware('permission:UpdateRole Roles And Permmonsins');
    Route::get('delete-role/{id}', [RolesAndPermissionsController::class, 'delete'])->middleware('permission:Delete Roles And Permmonsins');
});
