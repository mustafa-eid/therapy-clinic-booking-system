...
<head>
    ...
    <!-- Datepicker CSS -->
    <link rel="stylesheet" href="{{ asset('patient-assets/css/bootstrap-datetimepicker.min.css') }}">

    <!-- Apex CSS -->
    <link rel="stylesheet" href="{{ asset('patient-assets/plugins/apex/apexcharts.css') }}">
